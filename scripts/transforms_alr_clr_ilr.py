...
outPath = '~/lognorm_v_coda/'

for study in studyList:
    meta_path = '~/beta_diversity_testing/'+study+'/meta.txt'
    data_path = '~/beta_diversity_testing/'+study+'/'+study+'_ForwardReads_DADA2.txt'
    ...
    alr_out.to_csv(outPath + study + 'alr.csv')
    clr_out.to_csv(outPath + study + 'clr.csv')
    ilr_out.to_csv(outPath + study + 'ilr.csv')
